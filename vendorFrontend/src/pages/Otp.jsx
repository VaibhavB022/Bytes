...
const SignUp = () => {
  return (
    <div className='signup-container bg-white h-screen'>
        ...
        <img src={IconGreen} alt="IconGreen" className="h-56 w-56 mb-0 mx-auto"/>
    ...
    <Link to='/user' className='flex mx-auto items-center justify-center w-60 h-14 my-2.5 rounded-full border-2 border-black text-white bg-mainTheme'>
